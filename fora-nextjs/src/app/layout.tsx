...
export const metadata: Metadata = {
  ...
  description: "Производство алюминиевых угловых соединителей дляскругляющих профилей в чистых помещениях. Соответствие GMP и ISO. Доставка по всей России.",
  keywords: ["чистые помещения", "угловые соединители", "заглушки", "уголки", "уголки для профиля", "GMP", "cleanroom", "алюминиевые профили"],
  ...
  metadataBase: new URL("https://corner-profile.ru"),
  alternates: {
    canonical: "/",
  },
  openGraph: {
