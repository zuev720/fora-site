...
const categories = [
  ...
  },
  {
    ...
    description: 'Угловые соединители для скругляющего профиля с заведением под линолеум R50 / R70',
    features: ['Радиус: R50 / R70', 'Материал: Алюминий АД31', 'Покрытие: Порошковая окраска'],
  },
];
