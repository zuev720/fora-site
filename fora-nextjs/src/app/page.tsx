...
export const metadata: Metadata = {
  ...
  description: 'Производство алюминиевых соединительных элементов для чистых помещений. Полный цикл от отливки до порошковой окраски.',
  alternates: {
    canonical: '/',
  },
};
...
const categories = [
  {
    ...
    alt: 'Угловые соединители для скругляющего профиля радиусом R40 / R50 / R55 / R70 для внутренних углов',
    title: 'Соединители для внутренних углов',
    description: 'Угловые соединители для скругляющего профиля R40 / R50 / R55 / R70',
  ...
  },
  {
    ...
    alt: 'Угловые соединители для скругляющего профиля радиусом R50 / R55 / R70 для внешних углов',
    title: 'Соединители для внешних углов',
    description: 'Угловые соединители для скругляющего профиля R50 / R55 / R70 для внешних углов',
    features: ['Радиус: R50 / R55 / R70', 'Материал: Алюминий АД31', 'Покрытие: Порошковая окраска'],
  },
  {
    href: '/catalog',
    image: '/lenoleum-composition.webp',
    alt: 'Угловые соединители для скругляющего профиля с заведением под линолеум R70',
    title: 'Соединители с заведением под линолеум',
    description: 'Угловые соединители для скругляющего профиля с заведением под линолеум R70',
    features: ['Радиус: R70', 'Материал: Алюминий АД31', 'Покрытие: Порошковая окраска'],
  },
];
