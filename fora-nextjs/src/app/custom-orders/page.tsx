...
const capabilities = [
  { icon: faCompassDrafting, title: 'Нестандартные радиусы', description: 'Любые значения радиуса, не только стандартные. Изготовление по вашим требованиям.' },
  { icon: faRulerCombined, title: 'Индивидуальные размеры', description: 'Нестандартная длина и ширина элементов.' },
